...
- `RoomApplication` – головний клас для запуску програми
- `BinaryData` – клас, що серіалізується
- `BinaryCalculator` – клас з логікою обчислень (використовує агрегацію)
- `SerializationDemo` – демонстрація збереження та відновлення об'єкта
- `TestBinary` – клас для тестування коректності роботи
---
...
- реалізовано динамічне оновлення графіка при зміні колекції"# practica-part9" 
"# practica-part9" 
"# practica-part9" 
